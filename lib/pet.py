...
class Pet:
    ...
    def create(cls, name, species, owner_id):
        # equivalent to Pet(name, species, owner_id)
    ...
    def instance_from_db(cls, row):
        # first - check the dictionary for an existing instance of a pet, using the primary key
        ...
        if pet:
            ...
            # nothing was found, we should create a new instance and add it to our dictionary
